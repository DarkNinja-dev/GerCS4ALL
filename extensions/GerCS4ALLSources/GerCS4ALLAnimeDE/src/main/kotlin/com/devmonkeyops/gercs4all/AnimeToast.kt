...
@CloudstreamPlugin
class GerCS4ALLAnimeDEPlugin : BasePlugin() {
    override fun load() {
...
/** AnimeToast is deliberately isolated from the EN package so it is visible
 * in the German-only Anime profile and never in movie/series profiles. */
private class AnimeToast : MainAPI() {
